<%-- 
    Document   : footer
    Created on : Mar 25, 2019, 10:06:37 PM
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">Car Pooling</h2>
                    <p>Viaggia ovunque, senza perdere un rene.</p>
                </div>
            </div>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Via che non esiste 14, Burundi, Africa</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+39 0578954678</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@carpooling.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
