...
public class Autista extends Utente {
     ...
     * @param data_scadenza_patente data della scadenza della patente dell'autista
    ...
    /**
     * Metodo setter che consente di impostare il numero dei posti massimi dell'auto.
     * @param numero_posti numero dei posti massimi che l'autista può trasportare 
     */
    public void setNumero_posti(int numero_posti) {
        this.numero_posti = numero_posti;
    }
    /**
     * Metodo getter che ritorna la data della scadenza della patente dell'autista.
    ...
    /**
     * Metodo setter che imposta la data della scadenza della patente dell'autista.
