...
public class Feedback {
    ...
    /**
     * Costruttore che consente di settare alcuni parametri della classe Feedback.
     * @param id id del feedback
     * @param giudizio stringa che contiene il parere di un utente verso un autista o viceversa
    ...
    /**
     * Metodo getter che consente di ottenere l'email di colui che effettua la votazione.
     ...
     * @return stringa contenente l'opinione di un utente su un autista o su un passeggero
     */
     ...
     * @param giudizio stringa contenente l'opinione di un utente su un autista o su un passeggero 
     */
